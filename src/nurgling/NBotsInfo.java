...
//    }
    ...
    public NBotsInfo(NGameUI gui ) {
        ...
        try {
            ...
            layouts.get ( 0 ).add ( new NButton ( "FishRestorer", new FishRestorer ( gui ), "bots/icons/fishingReloader" ) );
...
//
            ...
            layouts.get ( 5 ).add ( new NButton ( "FarmerTobacco", new FarmerTobacco ( gui ),"bots/icons/tabaccoFarm") );
