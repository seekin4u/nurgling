...
public class NHitBox extends NArea {
    ...
    public static void init() {
        ...
        hitboxes.put("gfx/terobjs/vflag", new NHitBox(new Coord2d(-2.75, -2.75), new Coord2d(2.75, 2.75)));
        hitboxes.put("gfx/terobjs/gardenpot", new NHitBox(new Coord2d(-2.75, -2.75), new Coord2d(2.75, 2.75)));
        ...
        hitboxes.put("gfx/kritter/wolf/wolf", new NHitBox(new Coord2d(-11, -5.5), new Coord2d(11, 5.5)));
        ...
        hitboxes.put("gfx/kritter/horse", new NHitBox(new Coord2d ( -13.75, -5.5 ), new Coord2d ( 13.75, 5.5 ) ));
        hitboxes.put("gfx/kritter/horse/horse", new NHitBox(new Coord2d ( -13.75, -5.5 ), new Coord2d ( 13.75, 5.5 ) ));
        ...
        hitboxes.put("gfx/kritter/boar/boar", new NHitBox( new Coord2d ( -11, -5.5 ), new Coord2d ( 11, 5.5 ) ));
        hitboxes.put("gfx/kritter/cattle/cattle", new NHitBox( new Coord2d ( -10, -3 ), new Coord2d ( 10, 3 ) ));
